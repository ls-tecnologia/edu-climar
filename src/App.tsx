      ...
      >
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            {/* Hero Section */}
      <section className="relative min-h-screen flex items-center pt-20 pb-12 overflow-hidden bg-brand-dark">
        {/* Background & Decorative Elements */}
        <div className="absolute inset-0 z-0">
          {/* Brilhos Decorativos Ciano (Mantidos para o visual Premium) */}
          <div className="absolute top-1/4 -right-64 w-96 h-96 bg-brand-cyan/20 rounded-full blur-[120px]"></div>
          <div className="absolute bottom-1/4 -left-64 w-96 h-96 bg-brand-cyan/10 rounded-full blur-[120px]"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col items-start text-left">
              ...
              {/* IMAGEM MOBILE - CONTAINER ESTILO CARTÃO PREMIUM */}
              <motion.div
                initial={{ opacity: 0, scale: 0.95 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className="relative w-full max-w-sm mx-auto mb-10 lg:hidden"
              >
                <div className="relative aspect-[3/4] rounded-3xl overflow-hidden border border-white/10 shadow-2xl group">
                  ...
                  />
                  {/* Gradiente para o texto não sumir na foto */}
                  <div className="absolute inset-0 bg-gradient-to-t from-brand-dark via-brand-dark/40 to-transparent"></div>
                  
                  <div className="absolute bottom-0 left-0 w-full p-6">
                    <h3 className="text-xl font-bold text-white mb-1">Eduardo Lopes</h3>
                    <p className="text-brand-cyan font-medium text-sm">Técnico Especialista</p>
                  </div>
                </div>
              </motion.div>
            ...
            {/* IMAGEM DESKTOP - CONTAINER ESTILO CARTÃO PREMIUM */}
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
            ...
            >
              <div className="relative aspect-[3/4] rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_40px_rgba(0,229,255,0.15)] group">
                ...
                <div className="absolute bottom-0 left-0 w-full p-8 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                  <div className="inline-flex items-center gap-2 bg-brand-cyan/20 backdrop-blur-md border border-brand-cyan/30 px-3 py-1.5 rounded-full mb-3">
                    <Check className="w-3.5 h-3.5 text-brand-cyan" />
                    <span className="text-brand-cyan text-xs font-bold uppercase tracking-wider">Credenciado Midea</span>
                  </div>
                  <h3 className="text-3xl font-bold text-white mb-1 drop-shadow-lg">Eduardo Lopes</h3>
                  <p className="text-gray-300 font-medium drop-shadow-md">Técnico Especialista</p>
                </div>
              </div>
              
              {/* Brilho decorativo atrás da foto */}
              <div className="absolute -inset-4 bg-brand-cyan/20 rounded-[2.5rem] -z-10 blur-xl opacity-50 group-hover:opacity-70 transition-opacity duration-500"></div>
            </motion.div>
